...
| $C$ | 并发度 | $2\|\alpha\delta - \beta\gamma\|$，$C \in [0,1]$ |
| $\rho_A$ | 约化密度矩阵 | $\text{Tr}_B(\|\Psi\rangle\langle\Psi\|)$ |
| $S$ | 纠缠熵 | $-\text{Tr}(\rho_A \log_2 \rho_A)$，$S \in [0,1]$ |
| Schmidt 分解 | 纠缠的数学结构 | $\lambda_1\|u_1\rangle\|v_1\rangle + \lambda_2\|u_2\rangle\|v_2\rangle$ |
