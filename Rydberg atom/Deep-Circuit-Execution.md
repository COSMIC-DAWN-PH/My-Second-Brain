...
实现恒定熵的关键是**逻辑 [[横向隐形传态 (Transversal Teleportation)]]**——将标准量子隐形传态推广到容错逻辑层面的协议。
...
> 详细的数学推导、错误隔离证明、Gate Teleportation 推广以及中性原子实验实现，参见 [[横向隐形传态 (Transversal Teleportation)]]。
...
- [[横向隐形传态 (Transversal Teleportation)]] — 恒定熵运行的核心机制详解
- [[横向纠缠门 (Transversal Gate)]] — 横向 CZ 门的容错性来源
- [[量子纠错 (QEC)]] — 纠错码框架
